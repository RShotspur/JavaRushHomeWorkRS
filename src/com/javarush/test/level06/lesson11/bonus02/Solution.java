...
//        BufferedReader reader = new BufferedReader(new InputStreamReader(System.in));
//
//        String grandPaName = reader.readLine(); Cat catGrandPa = new Cat(grandPaName);
//
//        String grandMaName = reader.readLine(); Cat catGrandMa = new Cat(grandMaName);
//
//        String paName = reader.readLine(); Cat catPa = new Cat(paName, null, catGrandPa);
//
//        String motherName = reader.readLine(); Cat catMother = new Cat(motherName, catGrandMa, null);
//
//        String sonName = reader.readLine(); Cat catSon = new Cat(sonName, catMother, catPa);
//
//        String daughterName = reader.readLine(); Cat catDaughter = new Cat(daughterName, catMother, catPa);
//
